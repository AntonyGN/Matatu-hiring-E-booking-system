...
if(isset($_POST['submit']))
{
    ...
    if (strtotime($fromdate) < strtotime('today') || strtotime($todate) < strtotime('today')) {
        echo "<script>alert('Please select future dates.');</script>"; 
        echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
        exit;
    }
    
    // Check if the booking dates are more than 5 days
    $diff = abs(strtotime($todate) - strtotime($fromdate));
    $days = floor($diff / (60 * 60 * 24));
    if ($days > 5) {
        echo "<script>alert('You cannot book a vehicle for more than 5 days.');</script>"; 
        echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
        exit;
    }
    ...
    if($query1->rowCount()==0)
    {
        ...
        echo "<script>alert('Vehicle already booked for these days');</script>"; 
        echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
    }
}
?>  
...
<title>Matatu E-booking Portal | Vehicle Details</title>
<!--Bootstrap -->
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Share: <a href="https://www.facebook.com/waytodone/"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="https://twitter.com/antony_githendu"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="https://www.linkedin.com/in/antony-githendu-b72ab51b1/?originalSubdomain=ke"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="https://www.instagram.com/antony_githendu/"><i class="fa fa-instagram" aria-hidden="true"></i></a> </p>
        </div>
